...
# local import
import annotation_editing_2d as edit_box

import mask_lct_2 as mask_mode
...
class Window:
    ...
    def __init__(self, lct_dir, frame_num=0):
        ...
        # tools_menu.add_item("Switch to Mask Mode", 6)
        ...
        # cw.set_on_menu_item_activated(6, self.on_switch_to_mask_mode)
        ...
        # iw.set_on_menu_item_activated(6, self.on_switch_to_mask_mode)
    ...
    def update_image(self):
        ...
        for idx, b in enumerate(self.boxes_to_render):
            ...
            color = b[COLOR]
			 # Iterate over the vertices of the current box
            for i in range(len(b[VERTICES])):
                vertices = b[VERTICES]  # Get the vertices of the current box
    ...
    def on_switch_to_mask_mode(self):
        self.controls.close()
        mask_mode.Window((self.lct_path, self.output_path, self.pred_path), self.frame_num)
    ...
    def on_annotation_start(self):
        ...
        annotation_object = edit_box.Annotation(self.boxes, self.pred_boxes,
                                                ...
                                                self.image_window, self.image_widget, self.lct_path, self.frame_num, self.pred_path)
