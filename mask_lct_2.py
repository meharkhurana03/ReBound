...
import annotation_editing_2d as box_mode
...
class Window:
	...
	def __init__(self, lct_dir, frame_num=0):
		...
		self.lct_path, self.output_path, self.pred_path = lct_dir # In this case, LCT path is the path to the image directory,
		# output path is the path to the annotation directory
		...
		# self.scene_nav = gui.CollapsableVert("Directory Navigation", .25 * em, margin)
		...
		# tools_menu.add_item("Switch to Box Mode", 6)
		...
		# cw.set_on_menu_item_activated(6, self.on_switch_to_box_mode)	
		...
		# iw.set_on_menu_item_activated(6, self.on_switch_to_box_mode)
