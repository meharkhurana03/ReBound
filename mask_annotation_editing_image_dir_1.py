...
class Annotation:
	...
	def __init__(self, polys, pred_polys, polys_to_render,
		...
		# Load annotation labels from config file
		# self.annotation_labels = self.load_annotation_labels_from_config()
	...
	def confirm_exit(self):
		...
		mask_lct.Window((self.lct_path, self.output_path, self.pred_path))
